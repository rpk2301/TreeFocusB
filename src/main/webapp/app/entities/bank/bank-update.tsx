...
export const BankUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...bankEntity,
          assignedTo: bankEntity?.assignedTo?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="treefocusApp.bank.home.createOrEditLabel" data-cy="BankCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Treesowned" id="bank-treesowned" name="treesowned" data-cy="treesowned" type="text" />
              <ValidatedField id="bank-assignedTo" name="assignedTo" data-cy="assignedTo" label="Assigned To" type="select">
                <option value="" key="0" />
                {users
