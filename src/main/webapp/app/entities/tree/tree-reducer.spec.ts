...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tree.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TREE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TREE actions', async () => {
      const expectedActions = [
        {
