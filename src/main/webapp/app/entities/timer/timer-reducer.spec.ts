...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './timer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIMER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIMER actions', async () => {
      const expectedActions = [
        {
